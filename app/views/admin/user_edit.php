...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo site_url('admin/users/edit/' . $data['user']->id); ?>">
            <?php echo csrf_field(); ?>
                        ...
                        <?php foreach ($data['roles'] as $role): ?>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo $role->id; ?>"
                                    <?php echo in_array($role->id, $data['selected_roles'] ?? [], true) ? 'checked' : ''; ?>>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo site_url('admin/users'); ?>" class="btn btn-secondary">Back</a>
            </div>
        </form>
    </div>
</div>
