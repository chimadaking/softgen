        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Add New Provider</h4>
                </div>
                <div class="card-body">
                    <?php flash('error', '', 'alert alert-danger'); ?>
                    
                    <form method="POST" action="<?php echo site_url('admin/providers/create'); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" 
                                   ...
                                   placeholder="e.g., SMS-Man" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3"
                                      placeholder="Brief description"><?php echo h($data['description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="base_url_template" id="base_url_template" class="form-control" 
                                   ...
                                   placeholder="e.g., https://api.sms-man.com/control">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="documentation_url" id="documentation_url" class="form-control" 
                                   ...
                                   placeholder="https://sms-man.com/api">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">
                                Required for syncing services. For SMS-Man, schema can fetch “applications” list.
                            </small>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary flex-grow-1">Save Provider</button>
